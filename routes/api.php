...
Route::group([
    ...
    Route::get('forgetpassword/{email}', function ($email) {
        return response()->view('mails.form', ['email' => $email, 'errors' => session('errors', new \Illuminate\Support\MessageBag)]);
    })->name('forget')->middleware('signed');
